...
public class PreguntasActivity6 extends AppCompatActivity {
    ...
    private static final String ULTIMA_ACTIVIDAD = "preguntasActivity6";
        ...
        switch (botonPresionado) {
            case 1:
                preguntas = new String[][]{
                        ...
                        {"6Pregunta 6 del botón 1", "Opción 1", "Opción 2", "Opción 3", "Opción 1", "retroalimentacion"},
                        {"6Pregunta 7 del botón 1", "Opción 1", "Opción 2", "Opción 3", "Opción 2", "retroalimentacion"},
                        {"6Pregunta 8 del botón 1", "Opción 1", "Opción 2", "Opción 3", "Opción 3", "retroalimentacion"},
                        {"6Pregunta 9 del botón 1", "Opción 1", "Opción 2", "Opción 3", "Opción 1", "retroalimentacion"},
                        {"6Pregunta 10 del botón 1", "Opción 1", "Opción 2", "Opción 3", "Opción 2", "retroalimentacion"}
                };
                break;
            case 2:
                preguntas = new String[][]{
