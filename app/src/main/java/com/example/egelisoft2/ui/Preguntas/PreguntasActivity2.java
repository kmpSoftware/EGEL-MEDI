            ...
            case 1:
                preguntas = new String[][]{
                        {"¿Cuál es el objetivo principal del diseño arquitectónico de software?",
                                "Proporcionar una visión general de la estructura del software", "Escribir código para implementar características específicas", "Definir pruebas para validar el software",
                                "Proporcionar una visión general de la estructura del software",
                        ...
                        {"¿Qué patrón de diseño se utiliza para dividir una aplicación en módulos interconectados?",
                                "Arquitectura en capas", "Inyección de dependencias", "Patrón Decorador",
                                "Arquitectura en capas",
                                "La arquitectura en capas es un patrón de diseño que divide una aplicación en módulos interconectados."},
