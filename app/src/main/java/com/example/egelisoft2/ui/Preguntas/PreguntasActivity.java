            ...
            case 1:
                preguntas = new String[][]{
                        ...
                        {"¿Qué tipo de requerimiento se refiere a las capacidades del sistema para interactuar con otros sistemas?",
                                "requerimiento funcionales", "requerimiento no funcionales", "requerimiento de usuario","requerimento no funcionales",
                                "Los Requerimientos no funcionales se refieren a los atributos de calidad del sistema, como la eficiencia, la escalabilidad, la seguridad, etc. En este caso, la capacidad del sistema para interactuar con otros sistemas es un requerimiento de interoperabilidad, que es un subtipo de Requerimientos no funcionales."},

                        {" ¿Qué tipo de requerimiento se refiere a la capacidad del sistema para procesar grandes volúmenes de datos en poco tiempo?",
                                "Requerimientos funcionales", "Requerimientos no funcionales", "Requerimientos de usuario","Requerimientos no funcionales.",
                                "La capacidad del sistema para procesar grandes volúmenes de datos en poco tiempo es un requerimiento de rendimiento, que es un subtipo de Requerimientos no funcionales."},
